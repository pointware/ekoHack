...
from .views import index, items, videoEdit, dashboard, videoEditStep1, videoEditStep2, videoEditStep3, videoEditStep4, videoEditStep5, videoEditStep6, videoTemplate, go
...
urlpatterns = [
    ...
    url(r'^videoeditstep6$', videoEditStep6, name='videoEditStep6'),
