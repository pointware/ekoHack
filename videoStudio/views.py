...
def videoEditStep1(request):
    ...
    return render(request, 'videoStudio/videoEdit.html', {'form_step1': form_step1, 'form_step2': form_step2, 'form_step3': form_step3, 'form_step4': form_step4, 'form_step5': form_step5, 'video1':video})
